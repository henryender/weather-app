      ...
      <Box margin='2%'>
        <Box width={{ lg: '80%', md: '80%', sm: '80%', xs: '100%' }} margin="auto" mt={5}>
          <Typography textAlign='center'
           margin="2%" sx={{ fontSize: { lg: 25, md: 20, sm: 20, xs: 15 } }} fontFamily='cursive' fontWeight='500px'>
          ...
          <Box
            ...
            <Autocomplete
              ...
              renderOption={(props, option) => (
                <Box component="li" sx={{ '& > img': { mr: 2, flexShrink: 0, }, backgroundColor: 'beige' }} {...props} key={option.id}>
